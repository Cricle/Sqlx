...
|--------|------|-------|--------|-------|-----------|-------------|
| **Sqlx** | **9.08 μs** | 3.89 μs | 0.21 μs | **1.00** | **1.79 KB** | **1.00** |
| Dapper.AOT | 10.43 μs | 1.41 μs | 0.08 μs | 1.15 | 2.96 KB | 1.66 |
| FreeSql | 64.54 μs | 5.63 μs | 0.31 μs | 7.11 | 11.55 KB | 6.46 |

**结论：** Sqlx 比 Dapper.AOT 快 15%，比 FreeSql 快 7.1 倍。

**性能提升：** 相比之前版本，Sqlx 性能保持稳定（9.08 μs），得益于：
