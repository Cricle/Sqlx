...
Namespace Sqlx.Annotations
    ...
    Friend NotInheritable Class SqlxAttribute
...
";
    ...
    public override void Initialize(GeneratorInitializationContext context)
    {
        ...
        {
            pi.AddSource("SqlxAttribute.vb", VisualBasicAttributeSource);
        });
    ...
    internal class SyntaxReceiver : ISqlxSyntaxReceiver
    {
        ...
        public void OnVisitSyntaxNode(GeneratorSyntaxContext context)
        {
            ...
            if (context.Node is MethodBlockSyntax methodDeclarationSyntax)
            {
                ...
                if (methodSymbol.GetAttributes().Any(ad => ad.AttributeClass?.ToDisplayString() == "Sqlx.Annotations.SqlMarshalAttribute"))
                {
