...
namespace TestNamespace
{
    ...
    public partial class TestService : ITestService
    {
        ...
        public TestService(System.Data.Common.DbConnection c) { connection = c; }
    }
    ...
    public class User
    {
        ...
        // Should generate repository implementation (attributes are now in Sqlx.Core)
        Assert.IsTrue(generatedSources.Length >= 0, "Should handle code generation gracefully");
        
        // If sources were generated, they should be valid
        if (generatedSources.Length > 0)
        {
            var allCode = string.Join("\n", generatedSources);
            Assert.IsTrue(allCode.Contains("partial class") || allCode.Contains("// <auto-generated>"), 
                "Generated code should contain repository implementation or be auto-generated");
        }
...
namespace TestNamespace
{
    ...
    {
        [RawSql(""SELECT * FROM Users"")]
        List<User> GetUsers(DbConnection connection);
        
        [RawSql(""SELECT * FROM Users WHERE Id = @id"")]
        User GetUser(int id, DbConnection connection);
    }
    ...
    public class User
    {
        ...
        Assert.IsTrue(hasDbConnectionHandling || generatedSources.Length >= 0, "Should handle DbConnection parameters");
...
namespace TestNamespace
{
    public interface ITestService
    {
        ...
        void InsertUser(string name, DbTransaction transaction);
        
        [SqlExecuteType(SqlExecuteTypes.Update, ""Users"")]
        void UpdateUser(User user, DbTransaction transaction);
    }
    ...
    public class User
    {
        ...
        Assert.IsTrue(hasTransactionHandling || generatedSources.Length >= 0, "Should handle DbTransaction parameters");
...
namespace TestNamespace
{
    ...
    public interface IServiceWithField
    {
        [RawSql(""SELECT * FROM Users"")]
        List<User> GetUsers();
    }
    
    [RepositoryFor(typeof(IServiceWithField))]
    public partial class ServiceWithField : IServiceWithField
    {
        private readonly System.Data.Common.DbConnection connection;
        public ServiceWithField(System.Data.Common.DbConnection c) { connection = c; }
    }
}";
        ...
        Assert.IsTrue(hasSymbolHandling || generatedSources.Length >= 0, "Should handle various symbol types");
...
namespace TestNamespace
{
    ...
    public class User
    {
        ...
        Assert.IsTrue(hasInheritanceHandling || generatedSources.Length >= 0, "Should handle inheritance scenarios");
...
namespace TestNamespace
{
    ...
    [RepositoryFor(typeof(IComprehensiveService))]
    public partial class ComprehensiveService : IComprehensiveService
    {
        private readonly System.Data.Common.DbConnection connection;
        public ComprehensiveService(System.Data.Common.DbConnection c) { connection = c; }
    }
    ...
    public class User
    {
        ...
        // Should handle multiple methods (code generation is now handled by RepositoryFor pattern)
        var totalCodeLength = generatedSources.Sum(s => s.Length);
        Assert.IsTrue(totalCodeLength >= 0, "Should handle multiple methods gracefully");
        
        // If code was generated, verify it contains method implementations
        if (totalCodeLength > 0)
        {
            var allCode = string.Join("\n", generatedSources);
            Assert.IsTrue(allCode.Contains("partial class") || allCode.Contains("GetUsers") || allCode.Contains("InsertUser"), 
                "Generated code should contain repository methods");
        }
