...
|------|------|------------|---------|
| 单条查询 | **10.04 μs** | 11.69 μs (+16%) | 70.77 μs (+605%) |
| 内存分配 | **1.79 KB** | 2.96 KB (+65%) | 11.55 KB (+545%) |
...
|--------|------|-------|--------|-------|-----------|-------------|
| **Sqlx** | **10.04 μs** | 0.174 μs | 0.163 μs | **1.00** | **1.79 KB** | **1.00** |
| Dapper.AOT | 11.69 μs | 0.196 μs | 0.183 μs | 1.16 | 2.96 KB | 1.66 |
| FreeSql | 70.77 μs | 0.693 μs | 0.614 μs | 7.05 | 11.55 KB | 6.46 |

**结论：** Sqlx 比 Dapper.AOT 快 16%，比 FreeSql 快 7.0 倍。
...
|--------|------|-------|-----------|-------------|
| Dapper.AOT | 24.11 μs | 0.95 | 6.55 KB | 1.31 |
| **Sqlx** | **25.48 μs** | **1.00** | **4.98 KB** | **1.00** |
| FreeSql | 47.15 μs | 1.85 | 9.56 KB | 1.92 |
