...
public class CodeGenerationTestBase : VerifyBase
{
    ...
    {
        var syntaxTree = CSharpSyntaxTree.ParseText("using Sqlx.Annotations;\r\n" + source);
        ...
        var compilation = CSharpCompilation.Create(
            ...
            references,
            new CSharpCompilationOptions(OutputKind.DynamicallyLinkedLibrary, nullableContextOptions: nullableContextOptions, usings: new[] { "Sqlx.Annotations" }));
    ...
    {
        var syntaxTree = VisualBasicSyntaxTree.ParseText("Imports Sqlx.Annotations\r\n" + source);
