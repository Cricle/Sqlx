...
partial class SimpleTemplateDemo
{
    ...
    /// Retrieves entity data from the database.
    /// <para>📝 Original Template:</para>
    /// <code>SELECT {{columns:auto}} FROM {{table}} {{orderby:id}} {{limit:mysql|default=20}}</code>
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user ORDER BY id ASC TOP </code>
    /// <para>⚠️ Template Warnings:</para>
    /// <para>  • Parameter &apos;:auto&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>  • Parameter &apos;:id&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>  • Parameter &apos;:mysql&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>🚀 This method was generated by Sqlx Advanced Template Engine</para>
    /// </summary>
    /// <returns>A task containing the collection of entities.</returns>
    [global::Sqlx.Annotations.Sqlx("SELECT {{columns:auto}} FROM {{table}} {{orderby:id}} {{limit:mysql|default=20}}")]
    public System.Threading.Tasks.Task<System.Collections.Generic.List<SqlxDemo.Models.User>> GetUsersPagedAsync()
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user ORDER BY id ASC TOP ";
    ...
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE name = @name</code>
    /// <para>🔧 Template Parameters:</para>
    ...
    public System.Threading.Tasks.Task<System.Collections.Generic.List<SqlxDemo.Models.User>> GetUsersByNameAsync(string name)
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE name = @name";
    ...
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>UPDATE user SET name = @Name, email = @Email, age = @Age, salary = @Salary, department_id = @DepartmentId, is_active = @IsActive, bonus = @Bonus, performance_rating = @PerformanceRating WHERE id = @id</code>
    /// <para>🔧 Template Parameters:</para>
    /// <para>  • @Name (string)</para>
    ...
    /// <para>  • Parameter &apos;:auto&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>  • Parameter &apos;:id&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>  • Parameter &apos;Age&apos; not found in method signature</para>
    /// <para>  • Parameter &apos;Salary&apos; not found in method signature</para>
    /// <para>  • Parameter &apos;DepartmentId&apos; not found in method signature</para>
    /// <para>  • Parameter &apos;IsActive&apos; not found in method signature</para>
    /// <para>  • Parameter &apos;Bonus&apos; not found in method signature</para>
    /// <para>  • Parameter &apos;PerformanceRating&apos; not found in method signature</para>
    /// <para>🚀 This method was generated by Sqlx Advanced Template Engine</para>
    /// </summary>
    /// <param name="id">The id parameter.</param>
    /// <param name="name">The name parameter.</param>
    ...
    public System.Threading.Tasks.Task<int> UpdateUserAsync(int id, string name, string email)
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"UPDATE user SET name = @Name, email = @Email, age = @Age, salary = @Salary, department_id = @DepartmentId, is_active = @IsActive, bonus = @Bonus, performance_rating = @PerformanceRating WHERE id = @id";
    ...
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>UPDATE user SET is_active = 0 WHERE id = @id</code>
    /// <para>🔧 Template Parameters:</para>
    /// <para>  • @id (int)</para>
    /// <para>⚠️ Template Warnings:</para>
    /// <para>  • Parameter &apos;:id&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    ...
    public System.Threading.Tasks.Task<int> SoftDeleteUserAsync(int id)
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"UPDATE user SET is_active = 0 WHERE id = @id";
    ...
    /// Retrieves entity data from the database.
    /// <para>📝 Original Template:</para>
    /// <code>SELECT COUNT(*) FROM {{table}} WHERE is_active = 1</code>
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT COUNT(*) FROM user WHERE is_active = 1</code>
    /// <para>🚀 This method was generated by Sqlx Advanced Template Engine</para>
    /// </summary>
    /// <returns>A task containing the number of affected rows.</returns>
    [global::Sqlx.Annotations.Sqlx("SELECT COUNT(*) FROM {{table}} WHERE is_active = 1")]
    public System.Threading.Tasks.Task<int> GetActiveUserCountAsync()
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT COUNT(*) FROM user WHERE is_active = 1";
    ...
    /// Retrieves entity data from the database.
    /// <para>📝 Original Template:</para>
    /// <code>SELECT {{columns:auto|exclude=Password}} FROM {{table}} WHERE is_active = 1 {{orderby:name}} {{limit:mysql|default=10}}</code>
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE is_active = 1 ORDER BY name ASC TOP </code>
    /// <para>⚠️ Template Warnings:</para>
    /// <para>  • Parameter &apos;:auto&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    ...
    /// </summary>
    /// <returns>A task containing the collection of entities.</returns>
    [global::Sqlx.Annotations.Sqlx("SELECT {{columns:auto|exclude=Password}} FROM {{table}} WHERE is_active = 1 {{orderby:name}} {{limit:mysql|default=10}}")]
    public System.Threading.Tasks.Task<System.Collections.Generic.List<SqlxDemo.Models.User>> GetTopUsersAsync()
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE is_active = 1 ORDER BY name ASC TOP ";
