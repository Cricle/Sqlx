...
{
    /// <summary>
    /// Tests for MySqlDialectProvider to achieve comprehensive coverage.
    /// </summary>
    [TestClass]
    public class MySqlDialectProviderTests
    {
        ...
        [TestMethod]
        public void SqlDefine_ReturnsMySQLFormat()
        {
            // Act
            ...
            Assert.AreEqual(SqlDefine.MySql, sqlDefine);
        }

        [TestMethod]
        public void DialectType_ReturnsMySql()
        {
            // Act
            var dialectType = _provider.DialectType;

            // Assert
            Assert.AreEqual(SqlDefineTypes.MySql, dialectType);
        }

        [TestMethod]
        public void GenerateLimitClause_WithLimitAndOffset_ReturnsCorrectMySQLSyntax()
        {
            // Act
            var result = _provider.GenerateLimitClause(10, 5);

            // Assert - MySQL uses LIMIT offset, count format
        ...
        public void GenerateLimitClause_WithOffsetOnly_ReturnsCorrectSyntax()
        {
            ...
            // Assert - MySQL uses max value for unlimited rows
        ...
        public void GenerateUpsert_WithKeyColumns_ReturnsCorrectSQL()
        {
            ...
            Assert.IsTrue(result.Contains("`Name` = VALUES(`Name`)"));
            Assert.IsTrue(result.Contains("`Email` = VALUES(`Email`)"));
        }
        ...
        [TestMethod]
        public void GetDatabaseTypeName_WithDouble_ReturnsDOUBLE()
        {
            // Act
        ...
        [TestMethod]
        public void GetDatabaseTypeName_WithFloat_ReturnsFLOAT()
        {
            // Act
        ...
        [TestMethod]
        public void GetDatabaseTypeName_WithDateTime_ReturnsDATETIME()
        {
            // Act
        ...
        [TestMethod]
        public void GetDatabaseTypeName_WithGuid_ReturnsCHAR36()
        {
            // Act
        ...
        public void FormatDateTime_WithDateTime_ReturnsCorrectFormat()
        {
            ...
            // Assert
            Assert.AreEqual("'2023-12-25 14:30:45'", result);
        }

        [TestMethod]
        public void GetCurrentDateTimeSyntax_ReturnsCorrectMySQLFunction()
        {
            // Act
        ...
        public void GetConcatenationSyntax_WithMultipleExpressions_ReturnsCorrectSyntax()
        {
            ...
            // Assert
            Assert.AreEqual("CONCAT(field1, field2, field3)", result);
        }
        ...
        public void GetConcatenationSyntax_WithTwoExpressions_ReturnsCorrectSyntax()
        {
            ...
            // Assert
            Assert.AreEqual("CONCAT(firstName, lastName)", result);
        }
