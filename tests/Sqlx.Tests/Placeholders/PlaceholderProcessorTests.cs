// <copyright file="PlaceholderProcessorTests.cs" company="Sqlx">
...
/// <summary>
/// Tests for PlaceholderProcessor and SqlTemplate integration.
/// </summary>
[TestClass]
public class PlaceholderProcessorTests
{
    ...
    /// <summary>
    /// Tests for basic placeholder replacement.
    /// </summary>
    [TestClass]
    ...
    /// <summary>
    /// Tests for dynamic placeholder detection.
    /// </summary>
    [TestClass]
    public class DynamicPlaceholderTests
    {
        [TestMethod]
