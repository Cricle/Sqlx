...
static async Task Demo1_BasicCrudAsync(IDbConnection connection)
{
...
static async Task Demo2_SoftDeleteAsync(IDbConnection connection)
{
...
static async Task Demo3_AuditFieldsAsync(IDbConnection connection)
{
    PrintSection("3. 审计字段");
...
static async Task Demo4_OptimisticLockingAsync(IDbConnection connection)
{
...
static async Task Demo5_BatchOperationsAsync(IDbConnection connection)
{
    PrintSection("5. 批量操作");
...
static async Task Demo6_AdvancedQueriesAsync(IDbConnection connection)
{
    PrintSection("6. 复杂查询");
...
static async Task Demo7_TransactionsAsync(IDbConnection connection)
{
    PrintSection("7. 事务支持");
