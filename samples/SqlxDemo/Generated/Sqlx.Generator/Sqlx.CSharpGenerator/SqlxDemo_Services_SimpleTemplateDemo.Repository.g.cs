...
partial class SimpleTemplateDemo
{
    ...
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user ORDER BY id ASC LIMIT 20</code>
    /// <para>⚠️ Template Warnings:</para>
    /// <para>  • Parameter &apos;:auto&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    /// <para>  • Parameter &apos;:id&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    ...
    public System.Threading.Tasks.Task<System.Collections.Generic.List<SqlxDemo.Models.User>> GetUsersPagedAsync()
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user ORDER BY id ASC LIMIT 20";
    ...
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE is_active = 1 ORDER BY name ASC LIMIT 20</code>
    /// <para>⚠️ Template Warnings:</para>
    /// <para>  • Parameter &apos;:auto&apos; doesn&apos;t use the correct prefix for SQL Server (expected &apos;@&apos;)</para>
    ...
    public System.Threading.Tasks.Task<System.Collections.Generic.List<SqlxDemo.Models.User>> GetTopUsersAsync()
    {
        ...
        __cmd__ = connection.CreateCommand();
        __cmd__.CommandText = @"SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE is_active = 1 ORDER BY name ASC LIMIT 20";
