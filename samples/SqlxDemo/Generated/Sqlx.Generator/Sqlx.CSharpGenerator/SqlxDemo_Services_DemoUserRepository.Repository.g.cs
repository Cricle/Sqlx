...
partial class DemoUserRepository
{
    ...
    /// Retrieves entity data from the database.
    /// <para>📝 Original Template:</para>
    /// <code>SELECT {{columns:auto}} FROM {{table}} WHERE [IsActive] = 1</code>
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT id, name, email, age, salary, department_id, is_active, hire_date, bonus, performance_rating FROM user WHERE [IsActive] = 1</code>
    /// <para>🚀 This method was generated by Sqlx Advanced Template Engine</para>
    /// </summary>
    /// <returns>A task containing the collection of entities.</returns>
    [global::Sqlx.Annotations.Sqlx("SELECT {{columns:auto}} FROM {{table}} WHERE [IsActive] = 1")]
    ...
    /// <returns>A task containing the collection of entities.</returns>
    [global::Sqlx.Annotations.Sqlx("SELECT {{columns:auto}} FROM {{table}} WHERE [Age] BETWEEN @minAge AND @maxAge ORDER BY {{orderby:age}}")]
    ...
    /// Retrieves entity data from the database.
    /// <para>📝 Original Template:</para>
    /// <code>SELECT [Id], [Name], [Email], [Salary] FROM [user] WHERE [DepartmentId] = @{deptId} AND [Salary] &gt;= @{minSalary} ORDER BY [Salary] DESC</code>
    /// <para>📋 Generated SQL (Template Processed):</para>
    /// <code>SELECT [Id], [Name], [Email], [Salary] FROM [user] WHERE [DepartmentId] = @{deptId} AND [Salary] &gt;= @{minSalary} ORDER BY [Salary] DESC</code>
    /// <para>🚀 This method was generated by Sqlx Advanced Template Engine</para>
    /// </summary>
