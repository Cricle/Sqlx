...
namespace TestNamespace
{
    ...
    public partial class UserRepository : IRepository<User>
    {
        ...
        Assert.IsTrue(result.Contains("public TestNamespace.User? GetById(int id)"),
            "Should generate GetById method implementation");
        Assert.IsTrue(result.Contains("public int Create(TestNamespace.User entity)"),
            "Should generate Create method implementation");
        Assert.IsTrue(result.Contains("public int Update(TestNamespace.User entity)"),
            "Should generate Update method implementation");
        Assert.IsTrue(result.Contains("public int Delete(int id)"),
...
namespace TestNamespace
{
    ...
    public partial class AdvancedUserRepository : IAdvancedRepository<User, int>
    {
        ...
        Assert.IsTrue(result.Contains("public async System.Threading.Tasks.Task<TestNamespace.User?> GetByIdAsync"),
            "Should generate async GetById method");
        Assert.IsTrue(result.Contains("public int Create(TestNamespace.User entity)"),
            "Should generate Create method with correct entity type");
        Assert.IsTrue(result.Contains("public async System.Threading.Tasks.Task<int> CreateAsync"),
